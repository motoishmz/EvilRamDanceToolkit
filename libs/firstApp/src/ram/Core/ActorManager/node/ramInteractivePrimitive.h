...
/*
 this code is copied from satoruhiga's github repository
...
namespace ramInteractivePrimitives
{
	class Context;
	class Node;
	class RootNode;
...
class ramInteractivePrimitives::Node : public ofNode
{
...
class ramInteractivePrimitives::RootNode : public ramInteractivePrimitives::Node
{
public:
